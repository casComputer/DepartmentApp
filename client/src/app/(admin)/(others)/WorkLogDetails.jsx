...
import {
    fetchWorklogs
} from "@controller/admin/worklog.controller";
...
const RenderItem = ({
    ...
    const [showFullTopics,
        setShowFullTopics] = useState(false);
    ...
    return (
        <View
            ...
            <View className="flex-row justify-between items-center mb-2">
                <Text numberOfLines={2} className="text-lg font-black dark:text-white">
                    Subject: {"\n\t"}
                    {item.subject}
                </Text>
...
const WorkLogHistory = () => {
    ...
    useInfiniteQuery( {
        ...
        queryFn: ({
            pageParam = 1
        }) => fetchWorklogs(pageParam, teacherId),
