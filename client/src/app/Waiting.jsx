...
const Waiting = () => {
  ...
  return (
    <View className="flex-1 bg-primary justify-center items-center gap-2">
      <TouchableOpacity onPress={logout} className="absolute top-3 right-3">
      ...
      <TouchableOpacity onPress={()=> router.push('/common/profile/EditProfile')} className="mt-10">
        <Text className="text-xl font-black text-green-500">Update your contact details</Text>
      </TouchableOpacity>
    </View>
  );
};
