...
export const LoadingIndicator = ({
    ...
    if (type === "fetch")
        return <FetchIndicator size={size} color={resolvedColor} />;
    if (type === "history")
        return <HistoryIndicator size={size} color={resolvedColor} />;
    if (type === "delete")
        return <DeleteIndicator size={size} color={resolvedColor} />;
    return null;
};
